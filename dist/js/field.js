...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('index-chart-field', __webpack_require__(4));
    Vue.component('detail-chart-field', __webpack_require__(7));
    Vue.component('form-chart-field', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        $("span.chart").peity(this.field.type || 'pie', {
            fill: this.field.colors,
            radius: this.field.radius,
            innerRadius: this.field.innerRadius,
            delimiter: this.field.delimiter,
            height: this.field.height,
            max: this.field.max,
            min: this.field.min,
            stroke: this.field.stroke,
            strokeWidth: this.field.strokeWidth,
            padding: this.field.padding,
...
var render = function() {
  ...
  return _c("span", { staticClass: "chart" }, [_vm._v(_vm._s(_vm.field.value))])
}
var staticRenderFns = []
